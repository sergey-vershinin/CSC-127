...
def quarter(img2, levels):
     """
    51     Takes an image and the number of splits to make.
    52     Splits the image into regions (2**levels x 2**levels pieces)
    53     and averages each of these regions separately.
    54     Calls average() and setRegion() to average and set colors for the
    55     regions.
    56     """
     h = img2.shape[0]
     w = img2.shape[1]
